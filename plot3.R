# Function to crete the plot # 3 as part of the first project for the
# Exploratory Data Analysis course
createPlot3<-function(targetDataSet,plotLocation){
  # Fetch the data
  targetDataSubset <- loadDataSubset(targetDataSet)
  # Proceed to print the plot
  plotDataSubset(targetDataSubset,paste(plotLocation,"plot3.png",sep = "\\"))
